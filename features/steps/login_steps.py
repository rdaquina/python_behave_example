...
def user_logged_in_valid_credential(context):
    i_am_at_login_page(context)
    i_fill_the_username_with_credential(context)
    i_fill_the_password_with_credential(context)

@given('I am at the Login Page')
def i_am_at_login_page(context):
    BasePage.locate_element(BasePage, context, LoginPageLocators.access)
